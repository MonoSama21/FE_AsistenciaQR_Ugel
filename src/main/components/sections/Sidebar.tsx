...
const Sidebar = () => {
    ...
    <>
        {/* SIDEBAR DESKTOP */}
        <aside className="hidden md:flex w-64 min-h-screen flex-col fixed left-0 top-0 z-40 bg-gradient-to-b from-blue-950 to-blue-900 shadow-2xl">
            ...
            <div className="flex flex-col items-center py-8 px-4 border-b border-white/10">
                ...
                <h2 className="text-white font-extrabold text-base text-center leading-tight tracking-wide">SIAQR</h2>
                <p className="text-blue-300 text-xs font-medium text-center mt-0.5">UGEL CHINCHA</p>
            </div>
        ...
        <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-blue-950 border-t border-white/10 z-50 shadow-2xl">
