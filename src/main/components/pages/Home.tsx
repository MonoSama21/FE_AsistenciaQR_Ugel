                ...
                <div className="p-6 md:p-10">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="bg-gradient-to-r from-blue-900 to-blue-700 px-8 py-10 text-white text-center">
                            <h1 className="text-2xl md:text-4xl font-extrabold tracking-wide drop-shadow mb-3">
                        ...
                        <div className="p-6 md:p-8">
                            <div className="relative w-full rounded-xl overflow-hidden border border-gray-200 shadow-inner bg-gray-100 object-cover" style={{ height: '550px' }}>
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 opacity-0 peer-error:opacity-100">
